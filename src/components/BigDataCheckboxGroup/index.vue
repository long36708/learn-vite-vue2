<!--
 @Description: 大数据量checkbox组件 前端搜索 方案1
 性能比较差
...
<template>
  <div class="bigdata-checkbox-group-container">
    <div class="filter-container">
      <el-input v-model.trim="filterText" class="search-input"
      placeholder="请输入搜索内容" suffix-icon="h-ic<template>
        <div class="bigdata-checkbox-group-container">
          <div class="filter-container">
            <el-input
        ...
        export default {
          ...
          computed: {
            ...
            disableCheckAllCurrentPageBtn() {
              ...
              return (
                this.visibleList.length +
                  checkedLabelKeysWithoutCurrentPage.length >
                this.maxLength
              );
            ...
            isCurrentPageCheckedAll: {
              get() {
                ...
                if (
                  currentPageKeysLength === 0 ||
                  this.checkedLabelKeys.length === 0
                ) {
                  return false;
                }
                ...
                if (currentPageCheckedKeys.length !== currentPageKeysLength) {
                  ...
                  return this.currentPageKeys.every((key) =>
                    currentPageCheckedKeys.includes(key)
                  );
                }
              },
              set(value) {
            ...
            isCheckedLimit: {
              ...
              set(value) {
                if (value) {
                  ...
                  this.previousPageCheckedKeys = this.checkedLabelKeys.filter(
                    (item) => this.currentPageKeys.includes(item)
                  );
                } else {
                  this.checkedLabelKeys = [];
            ...
            isCheckedAll: {
              get() {
                ...
                this.isIndeterminate =
                  checkedCount > 0 && checkedCount < filterLength;
              ...
              set(value) {
                ...
                if (value) {
                  console.log("开始全选");
                  console.time("设置全选");
                  let nextCheckedKeys = this.filteredLabelList.map(
                    (item) => item?.id
                  );
                  if (
          ...
          watch: {
            ...
            visibleList(newValue) {
              ...
              this.previousPageCheckedKeys = this.checkedLabelKeys.filter(
                (item) => _currentPageKeys.includes(item)
              );
            ...
            checkedLabelKeys(nextCheckedKeys) {
              ...
              this.isIndeterminate =
                nextCheckedKeys > 0 &&
                nextCheckedKeys < this.filteredLabelList.length;
...
export default {
  ...
  watch: {
    ...
    checkedLabelKeys(nextCheckedKeys) {
      console.log("nextCheckedKeys", nextCheckedKeys);
      this.isIndeterminate =
        nextCheckedKeys > 0 && nextCheckedKeys < this.filteredLabelList.length;
    },
    pageSize(newValue) {
      this.innerPageSize = newValue;
    },
